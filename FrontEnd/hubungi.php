      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1 class="text-center"><span>AtongBae</span> </h1>
            <h2 class="text-center">Pengiriman barang cepat, aman, amanah dan harga ongkir murah.</h2>
            <h2 class="text-center">Jalan Raya Gondang - Bayan <br>
            Lokok Bengkok, Dusun Karang Jurang, Desa Genggelang, Kecamatan Gangga, Kabupaten Lombok Utara.
            Kode Pos 83353 <br>
            <i><strong>Email : </strong> atongbae1@gmail.com</i> <br>
            <i><strong>WhatsApp : </strong> +6281353652511</i> <br>
            <i><strong>Instagram : </strong> atongbae_</i> <br>
            </h2>
          </div>
        </div>
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="../assets/img/conten5.png" class="img-fluid animated" alt="" width="100%">
        </div>
      </div>
    </div>
